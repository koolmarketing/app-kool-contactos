...
<div class="panel-body">
  ...
  <div class="clearfix">
   ...
   <div class="content-box small-box degrw"><span class="col-md-6"><a href="/empresa/'.$anotacion->id.'">
   <img src="'.URL::to('/').'/uploads/fotos/'.$anotacion->foto.'" class="img-responsive text-left" width="60px" alt=""></a>
   </span>
   <span class="col-md-6"><h4 class="gray text-center">'.$anotacion->nombre_comercial.'</h4></span>
   </div> 
   <div class="panel-body">
   <p class="text-note col-lg-12"> '.$anotacion->mensaje.' </p>
